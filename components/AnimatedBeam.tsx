...
>(({ className, children }, ref) => {
  return (
    <div
      ref={ref}
      className={cn(
        "z-10 flex  aspect-square w-max min-w-max box-border  items-center justify-center rounded-full  bg-[#d5eeee] border-2 border-[#93bbf3] text-[#4B92F6] p-3 shadow-[0_0_20px_-12px_rgba(0,0,0,0.8)]",
        className
      )}
    >
      {children}
      ...
      >
        ...
        {/* <div className="flex lg:flex-row lg:h-[400px] flex-col h-full w-full items-stretch justify-between lg:gap-10 gap-32"> */}
          <div className="flex lg:flex-col justify-center">
            ...
            <div ref={mainCircleRef} className="bg-[#d5eeee] text-[#4B92F6] border-[#93bbf3] border-2 text-2xl px-4 z-10 flex h-12 w-max items-center justify-center rounded-full  p-3 " >
              {cancer.name}
            </div>
          </div>
