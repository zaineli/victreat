...
function ScrollButton() {
    ...
    return (
        <div
            ...
            className='fixed bottom-0 right-0 translate-x-[-50%] cursor-pointer opacity-50 hover:opacity-100 transition-opacity duration-300 translate-y-[-50%] bg-slate-500 md:w-24 md:h-24 h-20 w-20 rounded-full z-[100] p-1' style={{
