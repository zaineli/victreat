...
export default function CancerDiagnosisPage() {
  return (
    <div className="relative h-screen flex flex-col justify-start items-start bg-gradient-to-b from-[#f1ffe9] to-[#c0eaaa] text-gray-700 w-full px-8 py-32 md:px-24 md:py-48">
