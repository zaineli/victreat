...
const Page = (props: Props) => {
  ...
  return (
    <div className='bg-gradient-to-b from-[#f1ffe9] to-[#c0eaaa] text-gray-700'>
      <div>
        ...
        {/* <motion.div className=' py-12 sm:py-16  md:py-24 px-4 sm:px-16 md:px-32 lg:px-40 xl:px-80'
          initial='hidden'
          animate='visible'
          variants={variants}
        >
          <div className='flex flex-col md:flex-row gap-8 md:gap-16 lg:gap-32'>
            ...
            <motion.div className='text-base sm:text-lg md:text-[18px] flex-1'
              variants={variants}
            >
              At Victreat, we're not just building software - we're reshaping the future of the Cancer industry. Our friendly and talented team value high performance, low ego and a sense of autonomy, coupled with a strong and sociable support network.
            </motion.div>
          </div>
          {/* <div className='flex flex-col md:flex-row gap-4 sm:gap-6 md:gap-8 lg:gap-12 mt-12 sm:mt-16 md:mt-24'>
            <motion.div className='w-full md:w-1/3 bg-[#f1ffe9ab] p-4 sm:p-6 md:p-8 rounded-lg shadow-md'
              variants={variants}
            >
            ...
            <motion.div className='w-full md:w-1/3 bg-[#f1ffe9ab] rounded-lg shadow-md cover-image'
              variants={variants}
            >
