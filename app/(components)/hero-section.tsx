...
const HeroSection = () => {
  return (
    <div className="bg-background min-h-screen px-4 relative flex flex-col md:flex-row justify-center md:items-center items-start">
      <div className="z-[999] w-full text-center  flex flex-col items-center justify-between min-h-screen lg:pt-32 pt-16 pb-16 box-border">
        <div className="text-7xl sm:text-8xl  top-32 font-thin left-[50%] antipasto">
          Victreat
        </div>
        ...
        <div className="w-full">
          ...
          <p className="mx-auto text-base md:text-2xl mt-4 drop-shadow-xl bottom-8 md:w-[70%]  max-w-[800px] left-[50%] text-center ">
            With an increasingly complex treatment landscape, how can you ensure that you're getting the right medication?
          </p>
        </div>

      </div>
      <div className="absolute w-full md:h-full md:w-1/2 top-0 left-0 bg-gradient-to-b from-[#eee_80%] to-[#fafafa_90%] h-0 z-50"></div>
    </div>
  );
}
