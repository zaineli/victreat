              ...
              <div className="grid grid-cols-3">
                {
                  items.length > 0 ? items.map((item, index) => {
                    if (item?.type === 'cancer') {
                      ...
                      return <Link href={`/d?cancer=${cancer.name.replaceAll(' ', '+')}`} key={index} className="flex items-center gap-2 p-2 rounded-lg hover:bg-neutral-200 cursor-pointer">
                    ...
                    if (item?.type === 'treatment') {
                      ...
                      return <Link href={`/d?treatments=${cancer.name.replaceAll(' ', '+')}`} key={index} className="flex items-center gap-2 p-2 rounded-lg hover:bg-neutral-200 cursor-pointer">
